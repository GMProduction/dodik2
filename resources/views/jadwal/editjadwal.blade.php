    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    <div class="card-body">
                        <form action="/admin/jadwal/patch" method="POST">
                            @csrf
                                    ...
                                    <div class="form-group col-lg-2">
                                        ...
                                        <select class="form-control" id="idLelang" name="IdLelang">
                                            @foreach($lelangs as $lelang)
                                                <option value="{{ $lelang->id }}" {{ $jadwal->lelang_id === $lelang->id ? 'selected' : ''}}>{{ $lelang->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="keteranganJadwal" name="keteranganJadwal"
                                                   class="form-control"
                                                   placeholder="keteranganJadwal Jadwal" value="{{ $jadwal->keterangan }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" id="jadwalPrakualifikasi"
                                                   name="jadwalPrakualifikasi" value="{{ $jadwal->jadwal }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="btasWaktu" class="form-control-label">Batas Waktu Upload</label>
                                            <input class="form-control" type="date" id="btasWaktu" name="btasWaktu" value="{{ $jadwal->batas }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
