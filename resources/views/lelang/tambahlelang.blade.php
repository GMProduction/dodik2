                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="idLelang">ID Lelang</label>
                                            <input type="text" id="idLelang" name="idLelang" class="form-control"
                                                   placeholder="ID Lelang">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <input type="file" class="custom-file-input" id="filePenawaran" name="filePenawaran" lang="en">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <a>File Dok Teknis</a>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="fileTeknis" name="fileTeknis" lang="en">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="fileKualifikasi" name="fileKualifikasi" lang="en">
