        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/lelang/patch" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="kodeLelang" name="kodeLelang" class="form-control"
                                                   placeholder="Kode Lelang" value="{{ $lelang->kode_lelang }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="namaLelang" name="namaLelang" class="form-control"
                                                   placeholder="Nama Lelang" value="{{ $lelang->nama }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="linkWebsite" name="linkWebsite" class="form-control"
                                                   placeholder="Link Website" value="{{ $lelang->link }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="reward" name="reward" class="form-control"
                                                   placeholder="Reward" value="{{ $lelang->reward }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="kesulitan" name="kesulitan" class="form-control"
                                                   placeholder="Kesulitan" value="{{ $lelang->kesulitan }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        @if($lelang->file_penawaran !== '' || $lelang->file_penawaran !== null)
                                            <div>File Saat Ini: <br> <a href="{{ asset('/uploads/penawaran') }}/{{ $lelang->file_penawaran }}">{{ $lelang->file_penawaran }}</a></div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        @if($lelang->file_teknis !== '' || $lelang->file_teknis !== null)
                                            <div>File Saat Ini: <br> <a href="{{ asset('/uploads/teknis') }}/{{ $lelang->file_teknis }}">{{ $lelang->file_teknis }}</a></div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        @if($lelang->file_kualifikasi !== '' || $lelang->file_kualifikasi !== null)
                                            <div>File Saat Ini: <br> <a href="{{ asset('/uploads/kualifikasi') }}/{{ $lelang->file_kualifikasi }}">{{ $lelang->file_kualifikasi }}</a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
