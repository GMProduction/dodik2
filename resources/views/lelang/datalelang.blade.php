            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Data Lelang</h6>
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="/admin/lelang/add" class="btn btn-sm btn-neutral">Tambah Data</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="completion">File Penawaran</th>
                                <th scope="col" class="sort" data-sort="completion">File Teknis</th>
                                <th scope="col" class="sort" data-sort="completion">File Kualifikasi</th>
                                <th scope="col"></th>
                            </tr>
                            </thead>
                            <tbody class="list">
